...
import UpdateUserNameModel from "./UpdateUserNameModel";
  ...
  fetchRecentMedia() {
    fetch(
      ...
      .then(
          ...
          error => {
            console.log("Error fetching user recent media data from Instagram.",error);
          }
      );  
      ...
      <div>
       ...
       />
        ...
        <Grid container spacing={3} justify="flex-start">
          ...
          <UpdateUserNameModel {...this.props} 
